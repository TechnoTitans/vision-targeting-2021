...
#print("readExposureNum: " + str(readExposureNum))
#print("autoExposureSum: " + str(autoExposureSum))
...
#print("manualExposure: " + str(manualExposure))
...
def getUnfilteredValues(img):
    ...
    for blob in blobs:
        ...
        #test_d = 152.5 #(13*12)+5
        #test_dh = 0+12+12+12+12+12+12#17.5 + 12
        #angle = (math.degrees(math.atan(test_dh/test_d)))* (-1)
